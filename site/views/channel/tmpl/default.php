    ...
    <div class="miwovideos_box_content">
        ...
        <div class="miwovideos_channel_header">
            <div class="miwovideos_channel_title">
                <h1><a href="<?php echo MRoute::_('index.php?option=com_miwovideos&view=channel&channel_id='.$this->item->id.$this->Itemid); ?>"><?php echo $this->item->title; ?></a></h1>
            </div>
            ...
            <?php if($this->config->get('subscriptions')) { ?>
                <div class="miwovideos_subscribe" id="<?php echo $this->item->id ?>">
                    ...
                    <?php } ?>
                    <div class="miwovideos_subscribe_count" id="subs_count<?php echo $this->item->id ?>"><span class="subs_count"><?php echo number_format($this->item->subs); ?></span></div>
        ...
        <div class="miwovideos_description_stats">
            ...
            <?php } ?>
            <?php if($this->config->get('subscriptions')) { ?>
                <div class="title"><?php echo number_format($this->item->subs); ?></div> <?php echo $this->item->subs > 1 ? MText::_('COM_MIWOVIDEOS_SUBSCRIBERS') : MText::_('COM_MIWOVIDEOS_SUBSCRIBER'); ?><br>
            <?php } ?>
            <div class="title"><?php echo number_format($this->item->hits); ?></div> <?php echo $this->item->hits > 1 ? MText::_('COM_MIWOVIDEOS_VIEW') : MText::_('COM_MIWOVIDEOS_VIEWS'); ?><br>
