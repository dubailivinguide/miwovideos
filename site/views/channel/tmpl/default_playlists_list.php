...
if (count($this->items)) {
    ...
    foreach ($this->items as $item) {
        ...
        $full_url = MRoute::_('index.php?option=com_miwovideos&view=playlist&playlist_id='.$item->id.$this->Itemid);
        ...
        <div class="videos-items-list-box">
            ...
            <div class="playlists-items-list-box-content">
                ...
                <div class="playlists-meta">
                    <div class="miwovideos-meta-info">
                        <a class="date-created" href="<?php echo $full_url; ?>"><?php echo MText::_('COM_MIWOVIDEOS_VIEW_PLAYLIST'); ?>&nbsp;&nbsp;(<?php echo isset($item->total) ? $item->total : '0' ; ?>&nbsp;<?php echo MText::_('COM_MIWOVIDEOS_VIDEOS')?>)</a>
                    </div>
                </div>
            </div>
        </div>
