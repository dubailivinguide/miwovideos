...
# No Permission
defined('MIWI') or die;
$url = MRoute::_('index.php?option=com_miwovideos&view=video&video_id='.$this->item->id.$this->Itemid);
$channel_url = MRoute::_('index.php?option=com_miwovideos&view=channel&channel_id='.$this->item->channel_id.$this->Itemid);
        ...
        <div class="miwovideos_box_content">
            ...
            <div class="miwovideos_user_header">
                    ...
                    <?php if($this->config->get('subscriptions')) { ?>
                        <div class="miwovideos_subscribe" id="<?php echo $this->item->channel_id ?>">
                            <?php if (is_null($this->checksubscription)) { ?>
                                ...
                                <div class="miwovideos_subscribe_count" id="subs_count<?php echo $this->item->channel_id ?>"><span class="subs_count"><?php echo $this->item->channel_subs; ?></span></div>
                            ...
                            <?php } else { ?>
                                ...
                                <div style="display:none" class="miwovideos_subscribe_count" id="subs_count<?php echo $this->item->channel_id ?>"><span class="subs_count"><?php echo $this->item->channel_subs; ?></span></div>
                ...
                <div class="miwovideos_views_info">
                    <div class="miwovideos_views_count"><?php echo number_format($this->item->hits); ?> <?php echo MText::_('COM_MIWOVIDEOS_VIEWS');?></div><br>
