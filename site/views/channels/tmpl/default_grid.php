                        ...
                        <div class="miwovideos_subscribe" id="<?php echo $item->id; ?>">
                            <?php if (isset($subs)) { ?>
                                <?php if (in_array($item->id, $subs)) { ?>
                                    ...
                                    <div class="miwovideos_subscribe_count" style="display:none" id="subs_count<?php echo $item->id ?>"><span class="subs_count"><?php echo is_null($item->subs) ? '0' : number_format($item->subs); ?></span></div>
                                ...
                                <?php } else { ?>
                                    ...
                                    <div class="miwovideos_subscribe_count" id="subs_count<?php echo $item->id ?>"><span class="subs_count"><?php echo is_null($item->subs) ? '0' : number_format($item->subs); ?></span></div>
                            ...
                            <?php } else { ?>
                                ...
                                <div class="miwovideos_subscribe_count" id="subs_count<?php echo $item->id ?>"><span class="subs_count"><?php echo isset($item->subs) ? number_format($item->subs) : '0'; ?></span></div>
                                <div class="subs_nub"><s></s><i></i></div>
                                <a class="<?php echo MiwoVideos::getButtonClass(); ?> subscribed" style="display:none" id="unsubscribe_button"><?php echo MText::_('COM_MIWOVIDEOS_SUBSCRIBED'); ?></a>
                            <?php } ?>
                        </div>
