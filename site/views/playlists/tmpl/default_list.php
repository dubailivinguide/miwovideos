...
if (count($this->items)) {
	...
	foreach ($this->items as $item) {
		...
		$playlist_url = MRoute::_('index.php?option=com_miwovideos&view=playlist&playlist_id='.$item->id.$Itemid);
			...
			<div class="playlists-items-list-box-content">
				...
				<div class="playlists-items">
					...
					foreach ($item->videos as $video) {
						$j++; ?>
						<?php $Itemid = MiwoVideos::get('router')->getItemid(array('view' => 'video', 'video_id' => $video->video_id), null, true); ?>
				...
				<div class="playlists-meta">
					<div class="miwovideos-meta-info">
						<a class="date-created" href="<?php echo $playlist_url; ?>"><?php echo MText::_('COM_MIWOVIDEOS_VIEW_PLAYLIST'); ?>
