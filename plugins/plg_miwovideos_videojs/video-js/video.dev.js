...
vjs.get = function (url, onSuccess, onError, withCredentials) {
  ...
  request = new XMLHttpRequest();  urlInfo = vjs.parseUrl(url);
...
vjs.Slider = vjs.Component.extend({
  ...
  init: function(player, options){
    ...
    this.boundEvents = {};    this.boundEvents.move = vjs.bind(this, this.onMouseMove);
...
vjs.Player.prototype.unloadTech = function(){
  this.isReady_ = false;  this.tech.dispose();
...
vjs.Player.prototype.buffered = function(){
  var buffered = this.techGet('buffered');  if (!buffered || !buffered.length) {
...
vjs.ChaptersTrack.prototype.kind_ = 'chapters';/* Text Track Display
============================================================================= */
