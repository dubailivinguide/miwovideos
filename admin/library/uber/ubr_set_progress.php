...
if(!$found_flength_file){
	...
	showAlertMessage("ERROR: Failed to find <a href='http://uber-uploader.sourceforge.net/?section=flength' target='_new'>flength file</a>", 1);
	//showAlertMessage("<a href='http://miwisoft.com' target='_new'>ERROR: Failed to find flength file</a>", 1);
}
