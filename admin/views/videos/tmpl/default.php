...
<form action="<?php echo MRoute::getActiveUrl(); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <div style="float: left; width: 99%;">
        ...
        <button class="button btn-success" onclick="window.location = '<?php echo $utility->route('index.php?option=com_miwovideos&view=upload'); ?>';return false;"><span class="icon-new icon-white"></span> <?php echo MText::_('COM_MIWOVIDEOS_NEW'); ?></button>
        <?php } ?>
        ...
        <thead>
            <tr>
                ...
                <th class="title" style="text-align: left;">
                    <?php echo MHtml::_('grid.sort',  MText::_('COM_MIWOVIDEOS_TITLE'), 'title', $this->lists['order_Dir'], $this->lists['order'] ); ?>
                </th>
                <?php if ($this->acl->canAdmin()) { ?>
